...
return [
    'permalink_structure' => [
        ...
        'instructions' => 'Настройка структуры URL-адресов постоянных ссылок на посты и архивы. Данная настройка может сделать внешний вид ссылок более эстетичным, повысить удобство их использования и обеспечить между ними прямую совместимость.',//'Customize the URL structure for your permalinks and archives. This can improve the aesthetics, usability, and forward-compatibility of your links.',
    ],
    'module_segment'      => [
    ...
    'posts_per_page'      => [
        'label'        => 'Количество постов на странице',//'Posts Per Page',
    ...
    'ttl'                 => [
        ...
        'instructions' => 'Время (в минутах) кэширования постов перед тем, как будет размещён свежий контент.',//'How long (in minutes) do you want to cache posts before before serving fresh content?',
    ],
];
