...
return [
    ...
    'slug'           => [
        ...
        'instructions' => 'Уникальный текстовый идентификатор. Может состоять только из "безопасных" символов (маленькие латинские буквы, цифры, тире и подчёркивание).',//'The slug will be used when display blocks with the plugin.',
    ],
    'description'    => [
    ...
    'display_title'  => [
        'name'  => 'Отображать заголовок?',//'Display title?',
        'label' => 'Да, отображать заголовок.',//'Yes, display the block title.',
    ],
    'category'       => [
